...
<div class="container mt-3">
  ...
  <div class="col-md-9">
      ...
      <?php
       ...
       // $query = "SELECT IDProducto, NombreProducto, Descripcion, Precio, URLImagen FROM Productos";
       
      
// Realizar la consulta a la base de datos con la condición de búsqueda
if (isset($_GET['q'])) {
  $search_query = $_GET['q'];
  $query = "SELECT IDProducto, NombreProducto, Descripcion, Precio, URLImagen FROM Productos WHERE NombreProducto LIKE '%$search_query%'";
} else {
  $query = "SELECT IDProducto, NombreProducto, Descripcion, Precio, URLImagen FROM Productos";
}
    ...
    <div class="col-md-4 mb-4">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <a href="Producto.php?producto=<?= $row['IDProducto'] ?>" class="btn btn-primary">Ver Detalles</a>
        </div>
      </div>
    </div>
    <?php $count++; ?>
